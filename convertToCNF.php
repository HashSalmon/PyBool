...
$pythonExe = "C:\\Python27\\python.exe C:\\Users\\Kingsley\\cs4540\\PyBool\\python\\PBL_CNF.py"." ".$id;

// php calls python to run the python code to generate a graph
// or to generate a error.txt
$output=exec("C:\\Python27\\python.exe C:\\Users\\Kingsley\\cs4540\\PyBool\\python\\PBL_CNF.py"." ".$id);
